...
if not os.path.exists('SPP_SB_C1'):
    os.makedirs('SPP_SB_C1')
...
def display_solution(strip, rectangles, pos_circuits, instance_name):
    ...
    plt.savefig(f'SPP_SB_C1/{instance_name}.png')
    plt.close()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        for instance_id in range(39, 42):
            ...
            command = f"./runlim --time-limit={TIMEOUT} python3 SPP_SB_C1.py {instance_id}"
