...
def display_solution(strip, rectangles, pos_circuits, rotations, instance_name):
    ...
    plt.savefig(f'SPP_R/{instance_name}.png')
    plt.close()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        if os.path.exists(excel_file):
            ...
            # Tạo DataFrame trống nếu chưa có file Excel
        ...
        for instance_id in range(1, 42):
            ...
            command = f"./runlim --time-limit={TIMEOUT} python3 SPP_R.py {instance_id}"
