...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        for instance_id in range(1, 42):
            ...
            command = f"./runlim --time-limit={TIMEOUT} python3 GUROBI_MIP_R_SB.py {instance_id}"
    ...
    # Phần single instance mode
        ...
        try:
            ...
            # Solve with MIP
            result = solve_strip_packing(widths, heights, strip_width, time_limit=1740, allow_rotation=True)
